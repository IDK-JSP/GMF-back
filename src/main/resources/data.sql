...
('admin@gmail.com', 'Bœuf Bourguignon', 'boeuf bourguignon', 'Un délicieux plat mijoté de viande de bœuf, vin rouge et légumes.', NULL, 6, 'tovalidation', 4.5, 6, NOW(), NOW(), 180),
('admin@gmail.com', 'Tajine de poulet', 'tajine de poulet', 'Un plat marocain savoureux avec du poulet, des olives et des citrons confits.', NULL, 4, 'tovalidation', 4.7, 5, NOW(), NOW(), 90),
('admin@gmail.com', 'Lasagnes', 'lasagnes', 'Des couches de pâtes, sauce tomate, viande hachée et béchamel gratinée au four.', NULL, 6, 'tovalidation', 5.0, 8, NOW(), NOW(), 60),
('admin@gmail.com', 'Gâteau au chocolat', 'gateau au chocolat', 'Un gâteau moelleux et fondant au chocolat noir.', NULL, 8, 'tovalidation', 4.9, 10, NOW(), NOW(), 45),
('admin@gmail.com', 'Blanquette de veau', 'blanquette de veau', 'Un plat traditionnel français avec du veau mijoté dans une sauce crémeuse.', NULL, 6, 'tovalidation', 4.6, 7, NOW(), NOW(), 120),
('admin@gmail.com', 'Chili con carne', 'chili con carne', 'Un plat épicé mexicain à base de bœuf, haricots rouges et épices.', NULL, 4, 'tovalidation', 4.3, 6, NOW(), NOW(), 75),
('admin@gmail.com', 'Risotto aux champignons', 'risotto aux champignons', 'Un riz crémeux et savoureux avec des champignons et du parmesan.', NULL, 4, 'tovalidation', 4.8, 5, NOW(), NOW(), 40),
('admin@gmail.com', 'Paella', 'paella', 'Un plat espagnol à base de riz, fruits de mer et épices.', NULL, 6, 'tovalidation', 4.9, 8, NOW(), NOW(), 90),
('admin@gmail.com', 'Tiramisu', 'tiramisu', 'Dessert italien à base de café, mascarpone et biscuits imbibés.', NULL, 6, 'tovalidation', 4.9, 12, NOW(), NOW(), 20),
('admin@gmail.com', 'Burger maison', 'burger maison', 'Un délicieux burger avec steak haché, cheddar et sauce maison.', NULL, 2, 'tovalidation', 4.5, 4, NOW(), NOW(), 30),
('admin@gmail.com', 'Sushis variés', 'sushis varies', 'Assortiment de sushis faits maison avec poisson frais et riz vinaigré.', NULL, 4, 'tovalidation', 4.7, 6, NOW(), NOW(), 60),
('admin@gmail.com', 'Gratin dauphinois', 'gratin dauphinois', 'Des pommes de terre fondantes gratinées avec de la crème et du fromage.', NULL, 4, 'tovalidation', 4.6, 5, NOW(), NOW(), 70),
('admin@gmail.com', 'Omelette aux fines herbes', 'omelette fines herbes', 'Une omelette légère et savoureuse avec persil, ciboulette et estragon.', NULL, 2, 'tovalidation', 3.8, 3, NOW(), NOW(), 10),
('admin@gmail.com', 'Croque-monsieur', 'croque monsieur', 'Un sandwich chaud avec jambon, fromage et béchamel, grillé à la perfection.', NULL, 2, 'tovalidation', 4.2, 4, NOW(), NOW(), 15),
('admin@gmail.com', 'Pancakes américains', 'pancakes americains', 'Des pancakes moelleux à déguster avec du sirop d’érable.', NULL, 4, 'tovalidation', 4.8, 7, NOW(), NOW(), 20),
('admin@gmail.com', 'Soupe miso', 'soupe miso', 'Une soupe japonaise légère avec tofu, algues et miso.', NULL, 2, 'tovalidation', 4.1, 4, NOW(), NOW(), 10),
('admin@gmail.com', 'Riz cantonais', 'riz cantonais', 'Un riz sauté avec œufs, crevettes, petits pois et sauce soja.', NULL, 4, 'tovalidation', 4.3, 5, NOW(), NOW(), 25),
('admin@gmail.com', 'Crêpes sucrées', 'crepes sucrees', 'De délicieuses crêpes fines à garnir avec du sucre, chocolat ou confiture.', NULL, 6, 'tovalidation', 4.9, 9, NOW(), NOW(), 20),
('admin@gmail.com', 'Fondue savoyarde', 'fondue savoyarde', 'Un mélange de fromages fondus, parfait pour une soirée conviviale.', NULL, 4, 'tovalidation', 4.7, 6, NOW(), NOW(), 30),
('admin@gmail.com', 'Gaspacho', 'gaspacho', 'Une soupe froide rafraîchissante à base de tomates et légumes mixés.', NULL, 4, 'tovalidation', 4.5, 5, NOW(), NOW(), 15);
