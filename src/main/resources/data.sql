...
('admin@gmail.com', 'Chili con carne', 'chili con carne', 'Un plat épicé mexicain à base de bœuf, haricots rouges et épices.', 'recipe_16', 4, 'tovalidation', 4.3, 6, NOW(), NOW(), 75),
('admin@gmail.com', 'Risotto aux champignons', 'risotto aux champignons', 'Un riz crémeux et savoureux avec des champignons et du parmesan.', 'recipe_17', 4, 'tovalidation', 4.8, 5, NOW(), NOW(), 40),
('admin@gmail.com', 'Paella', 'paella', 'Un plat espagnol à base de riz, fruits de mer et épices.', 'recipe_18', 6, 'tovalidation', 4.9, 8, NOW(), NOW(), 90),
('admin@gmail.com', 'Tiramisu', 'tiramisu', 'Dessert italien à base de café, mascarpone et biscuits imbibés.', 'recipe_19', 6, 'tovalidation', 4.9, 12, NOW(), NOW(), 20),
('admin@gmail.com', 'Burger maison', 'burger maison', 'Un délicieux burger avec steak haché, cheddar et sauce maison.', 'recipe_20', 2, 'tovalidation', 4.5, 4, NOW(), NOW(), 30),
('admin@gmail.com', 'Sushis variés', 'sushis varies', 'Assortiment de sushis faits maison avec poisson frais et riz vinaigré.', 'recipe_21', 4, 'tovalidation', 4.7, 6, NOW(), NOW(), 60),
('admin@gmail.com', 'Gratin dauphinois', 'gratin dauphinois', 'Des pommes de terre fondantes gratinées avec de la crème et du fromage.', 'recipe_22', 4, 'tovalidation', 4.6, 5, NOW(), NOW(), 70),
('admin@gmail.com', 'Omelette aux fines herbes', 'omelette fines herbes', 'Une omelette légère et savoureuse avec persil, ciboulette et estragon.', 'recipe_23', 2, 'tovalidation', 3.8, 3, NOW(), NOW(), 10),
('admin@gmail.com', 'Croque-monsieur', 'croque monsieur', 'Un sandwich chaud avec jambon, fromage et béchamel, grillé à la perfection.', 'recipe_24', 2, 'tovalidation', 4.2, 4, NOW(), NOW(), 15),
('admin@gmail.com', 'Pancakes américains', 'pancakes americains', 'Des pancakes moelleux à déguster avec du sirop d’érable.', 'recipe_25', 4, 'tovalidation', 4.8, 7, NOW(), NOW(), 20),
('admin@gmail.com', 'Soupe miso', 'soupe miso', 'Une soupe japonaise légère avec tofu, algues et miso.', 'recipe_26', 2, 'tovalidation', 4.1, 4, NOW(), NOW(), 10),
('admin@gmail.com', 'Riz cantonais', 'riz cantonais', 'Un riz sauté avec œufs, crevettes, petits pois et sauce soja.', 'recipe_27', 4, 'tovalidation', 4.3, 5, NOW(), NOW(), 25),
('admin@gmail.com', 'Crêpes sucrées', 'crepes sucrees', 'De délicieuses crêpes fines à garnir avec du sucre, chocolat ou confiture.', 'recipe_28', 6, 'tovalidation', 4.9, 9, NOW(), NOW(), 20),
('admin@gmail.com', 'Fondue savoyarde', 'fondue savoyarde', 'Un mélange de fromages fondus, parfait pour une soirée conviviale.', 'recipe_29', 4, 'tovalidation', 4.7, 6, NOW(), NOW(), 30),
('admin@gmail.com', 'Gaspacho', 'gaspacho', 'Une soupe froide rafraîchissante à base de tomates et légumes mixés.', 'recipe_30', 4, 'tovalidation', 4.5, 5, NOW(), NOW(), 15);
