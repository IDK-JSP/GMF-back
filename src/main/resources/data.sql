...
('admin@gmail.com', 'Bœuf Bourguignon', 'boeuf bourguignon', 'Un délicieux plat mijoté de viande de bœuf, vin rouge et légumes.', 'recipe_0', 6, 'tovalidation', 4.5, 6, NOW(), NOW(), 180),
('admin@gmail.com', 'Tajine de poulet', 'tajine de poulet', 'Un plat marocain savoureux avec du poulet, des olives et des citrons confits.', 'recipe_0', 4, 'tovalidation', 4.7, 5, NOW(), NOW(), 90),
('admin@gmail.com', 'Lasagnes', 'lasagnes', 'Des couches de pâtes, sauce tomate, viande hachée et béchamel gratinée au four.', 'recipe_0', 6, 'tovalidation', 5.0, 8, NOW(), NOW(), 60),
('admin@gmail.com', 'Gâteau au chocolat', 'gateau au chocolat', 'Un gâteau moelleux et fondant au chocolat noir.', 'recipe_0', 8, 'tovalidation', 4.9, 10, NOW(), NOW(), 45),
('admin@gmail.com', 'Blanquette de veau', 'blanquette de veau', 'Un plat traditionnel français avec du veau mijoté dans une sauce crémeuse.', 'recipe_0', 6, 'tovalidation', 4.6, 7, NOW(), NOW(), 120),
